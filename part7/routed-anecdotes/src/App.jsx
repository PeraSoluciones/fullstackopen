...
const Footer = () => (
  <div>
    Anecdote app for{' '}
    <Link to='https://fullstackopen.com/' target='_blank'>
      Full Stack Open
    </Link>
    . See{' '}
    <Link
...
const CreateNew = (props) => {
  ...
  const create = useField('submit', 'create');
  ...
  const handleReset = () => {
    ...
    author.onChange(null, 'reset');
    info.onChange(null, 'reset');
  };
